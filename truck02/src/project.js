        ...
        var a = e("./GameManager")
          ...
          , p = function(e) {
			...
			t.prototype.adsButtonFunc2 = function() {
				window.location.href = "https://weibo.com/p/1005056404087010/home?from=page_100505&mod=TAB&is_hot=1"
			},
    ...
    GameUiTools: [function(e, t, n) {
        ...
        var o = {
            newSprite: function(e, t) {
                ...
                n.addComponent(cc.Sprite).spriteFrame = GameTools.love2048FrameCache.getSpriteFrame(e)) : n.addComponent(cc.Sprite).spriteFrame = new cc.SpriteFrame("res/rawassets/resources/" + e),
                n
            },
        ...
        var a = e("../common/PlayerInfo")
          ...
          , h = function(e) {
            ...
            t.prototype.adsButtonFunc = function() {
                ...
                b.default.Instance.createOneFruit(Math.floor(Math.random()*5)+5)
            }
            ,
